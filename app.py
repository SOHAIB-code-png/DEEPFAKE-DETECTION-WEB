...
model = keras.models.load_model("B:/Downloads/Deepfake Streamlit APP/best_modelk_FINAL_MINI_PROJECT.h5")
...
def predict_video(video_path):
    ...
    return "Fake" if fake_probability >= 0.5 else "Real"
...
if choice == "Home":
    ...
    st.image("B:\Downloads\Deepfake Streamlit APP\Leonardo_Phoenix_A_surreal_and_futuristic_digital_artwork_depi_3.jpg", caption="Example of Deepfake Media", use_column_width=True)
...
if "user" in st.session_state:
    ...
    if uploaded_file is not None:
        ...
        if st.button("Detect"):
            prediction = predict_video(temp_file.name)
